...
from Input import extract_data, resize_with_pad, IMAGE_SIZE_X, IMAGE_SIZE_Y
...
class Dataset(object):
    ...
    def read(self, img_rows=IMAGE_SIZE_X, img_cols=IMAGE_SIZE_Y, img_channels=1, nb_classes=10):
